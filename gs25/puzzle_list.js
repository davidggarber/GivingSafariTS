...
var puzzles = [
    ...
    { title: 'Gardens', thumb: 'gar', author: 'David Garber', type: types.logic, group: group.puzzle, orientation: orient.landscape, ir:false, feeder: [] },
    ...
    { title: 'Shouldn’t That Rhyme?', file: 'ShouldntThatRhyme', thumb: 'sho', author: 'Martyn Lovell', type: types.word, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [{meta:'coastal',number:2}] },
    { title: 'Signposts', thumb: 'sig', author: 'Tim Hannifin', type: types.word, group: group.puzzle, orientation: orient.landscape, ir:false, feeder: [] },
    { title: 'Ski Resort', thumb: 'ski', author: 'Joey Marianer', type: types.jigsaw, group: group.puzzle, orientation: orient.landscape, ir:false, feeder: [] },
    ...
    // { title: 'Outlines', thumb: 'oli', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [] },
    // { title: 'Parking Places', thumb: 'par', author: 'Peter Golde', type: types.word, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [] },
    // { title: 'Tire Change', thumb: 'tir', author: 'Ryan Berry', type: types.word, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [] },
    // { title: 'PBN1: Hot Summer Day', thumb: 'pbn', author: 'Jeffrey Lin', type: types.logic, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [] },
    // { title: 'Up to the Campgrounds', thumb: 'cam', author: 'Wei-Hwa Huang', type: types.logic, group: group.puzzle, orientation: orient.portrait, ir:false, feeder: [] },

    { title: 'Annual Anthem', thumb: 'ann', author: 'Rorke Haining', type: types.meta, group: group.meta, orientation: orient.portrait, ir:false, metaInfo: 'anthem', forget: 'AA_Forget.xhtml' },
    { title: 'Coastal Erosion', thumb: 'coa', author: 'Martyn Lovell', type: types.meta, group: group.meta, orientation: orient.portrait, ir:false, metaInfo: 'coastal', forget: 'CE_Forget.xhtml' },

...
var puzzles = [
    ...
    { title: 'Beef', thumb: '', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'ironChef',number:1}] },
    ...
    { title: 'Chicken', thumb: '', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'ironChef',number:2}] },
    { title: 'Cultural Cuisine', thumb: '', author: 'Martyn Lovell', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'smorgasbord',number:3}] },
    { title: "Ding's Dim Sum", file:'DingsDimSum', thumb: '', author: 'Philippe Nicolle', type: types.math, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'toaster',number:2}] },
    ...
    { title: 'Egg', thumb: '', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'ironChef',number:3}] },
    { title: 'Food Trucks', thumb: '', author: 'Jesse McGatha', type: types.logic, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'smorgasbord',number:4}] },
    { title: 'Foodie Games', thumb: '', author: 'Zhenya Ross', type: types.logic, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'fridge',number:4}] },
    { title: 'Foodoku', thumb: '', author: 'Jeffrey Lin', type: types.logic, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'fridge',number:3}] },
    { title: 'Fridge Raider', thumb: '', author: 'Jeffrey Lin', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'fridge',number:1}] },
    { title: 'Fridge Raider 2', thumb: '', author: 'Jeffrey Lin', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'fridge',number:2}] },
    ...
    { title: 'Greens', thumb: '', author: 'Margaret Shaver', type: types.trivia, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'toaster',number:3}] },
    { title: 'I Need A Gyro', thumb: '', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'smorgasbord',number:1}] },
    ...
    { title: 'Starters', thumb: '', author: 'Anne Grier', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'toaster',number:4}] },
    { title: "Stewart's Steakhouse", file: "StewartsSteakhouse", thumb: '', author: 'Philippe Nicolle', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'smorgasbord',number:2}] },
    ...
    { title: 'Wine', thumb: '', author: 'Rorke Haining', type: types.word, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'ironChef',number:4}] },
    { title: '🍽️🎥', file:'EmojiDM', thumb: '', author: 'Morgan Grobin', type: types.rebus, group: group.puzzle, orientation: orient.portrait, feeder: [{meta:'toaster',number:1}] },
